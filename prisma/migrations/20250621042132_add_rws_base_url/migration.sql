...
CREATE TABLE "new_ReviewSettings" (
    ...
    "externalApiUrl" TEXT,
    "rwsBaseUrl" TEXT NOT NULL DEFAULT 'http://localhost:3000',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_ReviewSettings" ("allowAnonymous", "autoPublish", "createdAt", "emailApiKey", "emailFromAddress", "emailFromName", "emailProvider", "externalApiUrl", "id", "mailtrapInboxId", "mailtrapToken", "maxReviewLength", "requireApproval", "reviewTemplate", "sendEmailNotification", "shop", "showOnProductPage", "starColor", "updatedAt") SELECT "allowAnonymous", "autoPublish", "createdAt", "emailApiKey", "emailFromAddress", "emailFromName", "emailProvider", "externalApiUrl", "id", "mailtrapInboxId", "mailtrapToken", "maxReviewLength", "requireApproval", "reviewTemplate", "sendEmailNotification", "shop", "showOnProductPage", "starColor", "updatedAt" FROM "ReviewSettings";
